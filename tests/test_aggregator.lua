...
test("Every death lands in row.deaths, not just the newest", function()
    ...
    assertEqual(row.deaths[1].recapID, 29, "newest first, as the API returns them")
    assertEqual(row.deaths[3].recapID, 27)
end)
...
test("A correlated Deaths column keeps every death too", function()
    ...
    assertEqual(rows[1].deaths[1].recapID, 29, "newest first here too")
end)
