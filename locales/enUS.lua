...
L["Time into the fight"] = "Time into the fight"
L["Death timestamps"] = "Death timestamps"
L["How a death is labelled in the Deaths tooltip and the death list. Time into the fight is the meter's own offset into the segment this window is showing, and falls back to the time of day on Overall, where the client does not report one."] = "How a death is labelled in the Deaths tooltip and the death list. Time into the fight is the meter's own offset into the segment this window is showing, and falls back to the time of day on Overall, where the client does not report one."
