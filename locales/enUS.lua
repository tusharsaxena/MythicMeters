...
L["Fade the controls until the pointer is over the title bar. Off keeps them always visible."] = "Fade the controls until the pointer is over the title bar. Off keeps them always visible."
