...
```
diff -r --strip-trailing-cr <tag>/LibKa0s MultiMeters/libs/LibKa0s   # 1 file: OptionsCompose.lua
diff -r --strip-trailing-cr <tag>/testkit MultiMeters/tests/_kit     # empty
```
